...
class FClient(object):
    ...
    def move_firewall_policy(self, **message):
        return self.send_req(MOVE_FIREWALL_POLICY,
                             **message
                             )
    # Monitor
    # Monitor
    def get_policy_statistics(self, **message):
        return self.send_req(GET_POLICY_STATISTICS,
                             **message
                             )

    def get_session(self, **message):
        return self.send_req(GET_SESSION,
                             **message
                             )
    ...
    def get_inteface_select(self, **message):
        return self.send_req(GET_Interface_Select,
                             **message
                             )                     
