...
{
    {% if vdom is defined %}
        "path": "/api/v2/monitor/firewall/policy/{{ id }}?vdom={{ vdom }}",
    {% else %}
        "path": "/api/v2/monitor/firewall/policy/{{ id }}/",
    {% endif %}    
    "method": "GET"
}
"""
...
{
    {% if vdom is defined %}
        "path": "/api/v2/monitor/firewall/session/select/?vdom={{ vdom }}&count={{ count }}",
    {% else %}
        "path": "/api/v2/monitor/firewall/session/select/?count={{ count }}",
    {% endif %}    
    "method": "GET"
}
"""
...
GET_SYSTEM_UseRange = """
{
    "path": "/api/v2/monitor/system/resource/select", 
    "method": "GET"
}
"""
